...
async def async_create_cloud_pipeline(hass: HomeAssistant) -> str | None:
    ...
    # Create a cloud pipeline with legacy engine ids if one does not exist.
    # The engine ids of the pipeline will be migrated
    # by the respective platforms on startup.
